...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('katalog', '0003_product_available_product_description'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cart', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='katalog.cart')),
